...
export const TitleBar = ({title, child}: props) => {
    return (
        <Stack marginTop={"-34px"}>
            <Stack sx={{ minHeight: "41px", backgroundColor: "#F5F5F5", color:"8089A0", fontSize:"16px" }} direction={"row"} fontSize={"16px"}>
            ...
            <Typography style={{ paddingBottom: "12px", fontSize: "24px", borderBottom: "1px solid #E5E5E5", fontWeight: "lighter", color: "#2679B5" }}>
